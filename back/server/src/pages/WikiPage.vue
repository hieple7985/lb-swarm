...
import * as mrdotiendat from "../libs/mrdotiendat"
...
const getTokenCount = async () => {
  ...
  if (contentSearch.value != ''){
    res = await mrdotiendat.getContentSearch(contentSearch.value, pageSize.value, currentPage.value);
  }else if(titleSearch.value != ''){
    res = await mrdotiendat.getFileSearch(titleSearch.value, pageSize.value, currentPage.value);
  }else{
    res = await mrdotiendat.getFileList(pageSize.value, currentPage.value);
  }
